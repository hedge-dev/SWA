...
SWA is a modding API designed for Unleashed Recompiled. It is not yet ready for external use and is currently only used internally by Unleashed Recompiled.
